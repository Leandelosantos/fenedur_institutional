...
const urlParamsBrands = new URLSearchParams(window.location.search);
const myParamBrands = urlParamsBrands.get("brand");
const siteBrand = products.find(
  (element) => element.name.toLowerCase() === myParamBrands.toLowerCase()
);
...
productContainer.innerHTML += `
        ...
        <div class="brandIn">
            ...
            <div class="gridBrandCountry">Paises</div>
        </div>`;
